...
class PairChecker implements Runnable {
	...
	public void run() {
		System.out.println(pm.getClass().getName()+"=="+Thread.currentThread().getName());
		while (true) {
 ...
 * Output: (Sample) 
 * pm1: Pair: x: 15, y: 15 checkCounter =  272 565 
 * pm2: Pair: x:16, y: 16 checkCounter = 3 956 974
 * 
 * pm1: Pair: x: 95, y: 95 checkCounter =    11 621 588
   pm2: Pair: x: 100, y: 100 checkCounter = 233 896 207
 */// :~
