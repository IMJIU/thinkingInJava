...
public class CarBuilder {
	/**
	 * Assembler  chassisQueue.take()
	 * ->ChassisBuilder carQueue.put(c);
	 * ->Assembler robotPool.hire(EngineRobot.class, this); 
	 * ->Robot assembler.car().addEngine();   assembler.barrier().await(); 
	 * ->Assembler barrier.await();finishingQueue.put(car);
	 * @param args
	 * @throws Exception
	 */
